...
describe MatchesHelper, :type => :helper do
    it 'returns the project preference number' do
        ...
        fake_group2 = Group.new(:group_name => "Group2", :id => 2, :first_choice => 1, :second_choice => 2, :third_choice => 3, :fourth_choice => 4, :fifth_choice => 5, :sixth_choice => 6, :seventh_choice => 7)
        fake_group3 = Group.new(:group_name => "Group3", :id => 3, :first_choice => 2, :second_choice => 1, :third_choice => 3, :fourth_choice => 4, :fifth_choice => 5, :sixth_choice => 6, :seventh_choice => 7)
        ...
        fake_match8 = Match.new(:project_name => "Project1", :group_name => "Group4")
        ...
        helper.choice_num(fake_match8).should eql("Not a top choice")
    end
end